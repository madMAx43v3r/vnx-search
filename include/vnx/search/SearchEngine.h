...
private:
	...
	std::shared_ptr<link_cache_t> get_link_cache(const stx::cstring& url_key);
...
private:
	...
	std::unordered_map<stx::cstring, uint32_t> redirects;
	std::unordered_map<stx::cstring, std::shared_ptr<link_cache_t>> link_cache;
