...
public:
	...
	uint64_t load(const std::string& url = "", 
			const std::function<void(std::shared_ptr<const ::vnx::search::LoadResult>)>& _callback = std::function<void(std::shared_ptr<const ::vnx::search::LoadResult>)>(),
			const std::function<void(const vnx::exception&)>& _error_callback = std::function<void(const vnx::exception&)>());
	...
	uint64_t register_parser(const ::vnx::Hash64& address = ::vnx::Hash64(), const std::vector<std::string>& mime_types = {}, const int32_t& num_threads = 0, 
			const std::function<void()>& _callback = std::function<void()>(),
			const std::function<void(const vnx::exception&)>& _error_callback = std::function<void(const vnx::exception&)>());
...
private:
	...
	std::unordered_map<uint64_t, std::pair<std::function<void(std::shared_ptr<const ::vnx::search::LoadResult>)>, std::function<void(const vnx::exception&)>>> vnx_queue_load;
	std::unordered_map<uint64_t, std::pair<std::function<void(std::shared_ptr<const ::vnx::search::FetchResult>)>, std::function<void(const vnx::exception&)>>> vnx_queue_fetch;
	std::unordered_map<uint64_t, std::pair<std::function<void()>, std::function<void(const vnx::exception&)>>> vnx_queue_register_parser;
