...
class SearchFrontendAsyncClient : public vnx::AsyncClient {
public:
	SearchFrontendAsyncClient(const std::string& service_name);
	
	SearchFrontendAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_vnx_search_SearchFrontend_ASYNC_CLIENT_HXX_
