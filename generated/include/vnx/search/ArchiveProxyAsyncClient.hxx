...
#ifndef INCLUDE_vnx_search_ArchiveProxy_ASYNC_CLIENT_HXX_
#define INCLUDE_vnx_search_ArchiveProxy_ASYNC_CLIENT_HXX_
...
class ArchiveProxyAsyncClient : public vnx::AsyncClient {
public:
	ArchiveProxyAsyncClient(const std::string& service_name);
	
	ArchiveProxyAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_vnx_search_ArchiveProxy_ASYNC_CLIENT_HXX_
