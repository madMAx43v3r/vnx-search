...
#ifndef INCLUDE_vnx_search_QueryEngine_ASYNC_CLIENT_HXX_
#define INCLUDE_vnx_search_QueryEngine_ASYNC_CLIENT_HXX_
...
class QueryEngineAsyncClient : public vnx::AsyncClient {
public:
	QueryEngineAsyncClient(const std::string& service_name);
	
	QueryEngineAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_vnx_search_QueryEngine_ASYNC_CLIENT_HXX_
