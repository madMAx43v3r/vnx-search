...
public:
	...
	uint64_t parse(std::shared_ptr<const ::vnx::search::HttpResponse> response = nullptr, 
...
private:
	...
	std::unordered_map<uint64_t, std::pair<std::function<void(std::shared_ptr<const ::vnx::search::TextResponse>)>, std::function<void(const vnx::exception&)>>> vnx_queue_parse;
