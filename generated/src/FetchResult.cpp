...
std::string FetchResult::get_type_name() const {
...
vnx::Object FetchResult::to_object() const {
	vnx::Object _object;
	_object["__type"] = "vnx.search.FetchResult";
...
vnx::Variant FetchResult::get_field(const std::string& _name) const {
	if(_name == "redirect") {
...
void FetchResult::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "redirect") {
		_value.to(redirect);
...
std::shared_ptr<vnx::TypeCode> FetchResult::static_create_type_code() {
	...
	type_code->native_size = sizeof(::vnx::search::FetchResult);
