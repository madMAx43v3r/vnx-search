...
const vnx::Hash64 LoadResult::VNX_TYPE_HASH(0xcc058b7daab50123ull);
const vnx::Hash64 LoadResult::VNX_CODE_HASH(0xd1a5ad62f4cc89f6ull);

vnx::Hash64 LoadResult::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string LoadResult::get_type_name() const {
	return "vnx.search.LoadResult";
}

const vnx::TypeCode* LoadResult::get_type_code() const {
	return vnx::search::vnx_native_type_code_LoadResult;
}

std::shared_ptr<LoadResult> LoadResult::create() {
	return std::make_shared<LoadResult>();
}

std::shared_ptr<vnx::Value> LoadResult::clone() const {
	return std::make_shared<LoadResult>(*this);
}

void LoadResult::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void LoadResult::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
	vnx::write(_out, *this, _type_code, _code);
}

void LoadResult::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = vnx::search::vnx_native_type_code_LoadResult;
...
void LoadResult::write(std::ostream& _out) const {
	_out << "{\"__type\": \"vnx.search.LoadResult\"";
...
void LoadResult::read(std::istream& _in) {
	if(auto _json = vnx::read_json(_in)) {
		from_object(_json->to_object());
	}
}

vnx::Object LoadResult::to_object() const {
	vnx::Object _object;
	_object["__type"] = "vnx.search.LoadResult";
...
void LoadResult::from_object(const vnx::Object& _object) {
...
vnx::Variant LoadResult::get_field(const std::string& _name) const {
	if(_name == "redirect") {
...
void LoadResult::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "redirect") {
		_value.to(redirect);
...
/// \private
std::ostream& operator<<(std::ostream& _out, const LoadResult& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, LoadResult& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* LoadResult::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> LoadResult::static_create_type_code() {
	auto type_code = std::make_shared<vnx::TypeCode>();
	type_code->name = "vnx.search.LoadResult";
	type_code->type_hash = vnx::Hash64(0xcc058b7daab50123ull);
	type_code->code_hash = vnx::Hash64(0xd1a5ad62f4cc89f6ull);
	type_code->is_native = true;
	type_code->is_class = true;
	type_code->native_size = sizeof(::vnx::search::LoadResult);
	type_code->parents.resize(1);
	type_code->parents[0] = ::vnx::search::UrlInfo::static_get_type_code();
	type_code->create_value = []() -> std::shared_ptr<vnx::Value> { return std::make_shared<LoadResult>(); };
...
void write(TypeOutput& out, const ::vnx::search::LoadResult& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::search::vnx_native_type_code_LoadResult;
		out.write_type_code(type_code);
		vnx::write_class_header<::vnx::search::LoadResult>(out);
	}
