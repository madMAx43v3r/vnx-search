...
uint64_t CrawlProcessorAsyncClient::vnx_get_config_object(const std::function<void(const ::vnx::Object&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t CrawlProcessorAsyncClient::vnx_get_config(const std::string& name, const std::function<void(const ::vnx::Variant&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t CrawlProcessorAsyncClient::vnx_set_config_object(const ::vnx::Object& config, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t CrawlProcessorAsyncClient::vnx_set_config(const std::string& name, const ::vnx::Variant& value, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t CrawlProcessorAsyncClient::vnx_get_type_code(const std::function<void(const ::vnx::TypeCode&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t CrawlProcessorAsyncClient::vnx_get_module_info(const std::function<void(std::shared_ptr<const ::vnx::ModuleInfo>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t CrawlProcessorAsyncClient::vnx_restart(const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t CrawlProcessorAsyncClient::vnx_stop(const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t CrawlProcessorAsyncClient::vnx_self_test(const std::function<void(const vnx::bool_t&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t CrawlProcessorAsyncClient::get_stats(const int32_t& limit, const std::function<void(const ::vnx::Object&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t CrawlProcessorAsyncClient::check_all_urls(const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
	auto _method = ::vnx::search::CrawlProcessor_check_all_urls::create();
	const auto _request_id = ++vnx_next_id;
	{
		std::lock_guard<std::mutex> _lock(vnx_mutex);
		vnx_pending[_request_id] = 10;
		vnx_queue_check_all_urls[_request_id] = std::make_pair(_callback, _error_callback);
	}
	vnx_request(_method, _request_id);
	return _request_id;
}

uint64_t CrawlProcessorAsyncClient::check_root_urls(const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
	auto _method = ::vnx::search::CrawlProcessor_check_root_urls::create();
	const auto _request_id = ++vnx_next_id;
	{
		std::lock_guard<std::mutex> _lock(vnx_mutex);
		vnx_pending[_request_id] = 11;
		vnx_queue_check_root_urls[_request_id] = std::make_pair(_callback, _error_callback);
	}
	vnx_request(_method, _request_id);
	return _request_id;
}

int32_t CrawlProcessorAsyncClient::vnx_purge_request(uint64_t _request_id, const vnx::exception& _ex) {
	...
	switch(_index) {
		...
		case 10: {
			const auto _iter = vnx_queue_check_all_urls.find(_request_id);
			if(_iter != vnx_queue_check_all_urls.end()) {
				const auto _callback = std::move(_iter->second.second);
				vnx_queue_check_all_urls.erase(_iter);
				_lock.unlock();
				if(_callback) {
					_callback(_ex);
				}
		...
		case 11: {
			const auto _iter = vnx_queue_check_root_urls.find(_request_id);
			if(_iter != vnx_queue_check_root_urls.end()) {
				const auto _callback = std::move(_iter->second.second);
				vnx_queue_check_root_urls.erase(_iter);
				_lock.unlock();
				if(_callback) {
					_callback(_ex);
				}
...
int32_t CrawlProcessorAsyncClient::vnx_callback_switch(uint64_t _request_id, std::shared_ptr<const vnx::Value> _value) {
	std::unique_lock<std::mutex> _lock(vnx_mutex);
	const auto _iter = vnx_pending.find(_request_id);
	if(_iter == vnx_pending.end()) {
		throw std::runtime_error("CrawlProcessorAsyncClient: received unknown return");
	}
	const auto _index = _iter->second;
	vnx_pending.erase(_iter);
	switch(_index) {
		case 0: {
			const auto _iter = vnx_queue_vnx_get_config_object.find(_request_id);
			if(_iter == vnx_queue_vnx_get_config_object.end()) {
				throw std::runtime_error("CrawlProcessorAsyncClient: callback not found");
			}
			...
			if(_callback) {
				if(auto _result = std::dynamic_pointer_cast<const ::vnx::ModuleInterface_vnx_get_config_object_return>(_value)) {
					...
					throw std::logic_error("CrawlProcessorAsyncClient: invalid return value");
				}
			}
			break;
		}
		...
		case 9: {
			...
			_lock.unlock();
			if(_callback) {
				if(auto _result = std::dynamic_pointer_cast<const ::vnx::search::CrawlProcessor_get_stats_return>(_value)) {
					_callback(_result->_ret_0);
				} else if(_value && !_value->is_void()) {
					_callback(_value->get_field_by_index(0).to<::vnx::Object>());
				} else {
		...
		default:
			if(_index >= 0) {
				throw std::logic_error("CrawlProcessorAsyncClient: invalid callback index");
			}
	}
	return _index;
}
