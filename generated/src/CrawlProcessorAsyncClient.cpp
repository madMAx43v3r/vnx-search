...
uint64_t CrawlProcessorAsyncClient::vnx_get_config_object(const std::function<void(::vnx::Object)>& _callback, const std::function<void(const std::exception&)>& _error_callback) {
...
uint64_t CrawlProcessorAsyncClient::vnx_get_config(const std::string& name, const std::function<void(::vnx::Variant)>& _callback, const std::function<void(const std::exception&)>& _error_callback) {
...
uint64_t CrawlProcessorAsyncClient::vnx_set_config_object(const ::vnx::Object& config, const std::function<void()>& _callback, const std::function<void(const std::exception&)>& _error_callback) {
...
uint64_t CrawlProcessorAsyncClient::vnx_set_config(const std::string& name, const ::vnx::Variant& value, const std::function<void()>& _callback, const std::function<void(const std::exception&)>& _error_callback) {
...
uint64_t CrawlProcessorAsyncClient::vnx_restart(const std::function<void()>& _callback, const std::function<void(const std::exception&)>& _error_callback) {
...
uint64_t CrawlProcessorAsyncClient::vnx_close(const std::function<void()>& _callback, const std::function<void(const std::exception&)>& _error_callback) {
...
void CrawlProcessorAsyncClient::vnx_callback_switch(uint64_t _request_id, std::shared_ptr<const vnx::Value> _value) {
	...
	if(_type_hash == vnx::Hash64(0xa913f47dc68e4876ull)) {
		...
		if(_iter != vnx_queue_vnx_get_config_object.end()) {
			...
			throw std::runtime_error("CrawlProcessorAsyncClient: received unknown return request_id");
		}
	}
		...
		throw std::runtime_error("CrawlProcessorAsyncClient: received unknown return type");
	}
}
