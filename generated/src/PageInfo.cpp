...
const vnx::Hash64 PageInfo::VNX_CODE_HASH(0xa5c7b3eacf90605eull);
...
void PageInfo::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[2], 2); vnx::accept(_visitor, rank_value);
	...
	_visitor.type_field(_type_code->fields[6], 6); vnx::accept(_visitor, array_version);
	_visitor.type_field(_type_code->fields[7], 7); vnx::accept(_visitor, words);
	_visitor.type_field(_type_code->fields[8], 8); vnx::accept(_visitor, links);
	_visitor.type_field(_type_code->fields[9], 9); vnx::accept(_visitor, reverse_links);
	_visitor.type_field(_type_code->fields[10], 10); vnx::accept(_visitor, reverse_domains);
...
std::shared_ptr<vnx::TypeCode> PageInfo::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0xa5c7b3eacf90605eull);
...
void read(TypeInput& in, ::vnx::search::PageInfo& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const vnx::TypeField* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 8: vnx::read(in, value.links, type_code, _field->code.data()); break;
			case 9: vnx::read(in, value.reverse_links, type_code, _field->code.data()); break;
			case 10: vnx::read(in, value.reverse_domains, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::vnx::search::PageInfo& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 5, value.rank_value);
	vnx::write_value(_buf + 9, value.index_version);
	vnx::write_value(_buf + 17, value.link_version);
	vnx::write_value(_buf + 25, value.word_version);
	vnx::write_value(_buf + 33, value.array_version);
	vnx::write(out, value.words, type_code, type_code->fields[7].code.data());
	vnx::write(out, value.links, type_code, type_code->fields[8].code.data());
	vnx::write(out, value.reverse_links, type_code, type_code->fields[9].code.data());
	vnx::write(out, value.reverse_domains, type_code, type_code->fields[10].code.data());
}
