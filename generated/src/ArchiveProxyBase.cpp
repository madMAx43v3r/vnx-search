...
void ArchiveProxyBase::vnx_handle_switch(std::shared_ptr<const vnx::Value> _value) {
	const auto* _type_code = _value->get_type_code();
	while(_type_code) {
		switch(_type_code->type_hash) {
			case 0xd6552db423d70e21ull:
				handle(std::static_pointer_cast<const ::vnx::search::HttpResponse>(_value));
				return;
			default:
