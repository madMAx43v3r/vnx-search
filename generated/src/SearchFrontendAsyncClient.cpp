...
uint64_t SearchFrontendAsyncClient::vnx_get_config_object(const std::function<void(::vnx::Object)>& _callback, const std::function<void(const std::exception&)>& _error_callback) {
...
uint64_t SearchFrontendAsyncClient::vnx_get_config(const std::string& name, const std::function<void(::vnx::Variant)>& _callback, const std::function<void(const std::exception&)>& _error_callback) {
...
uint64_t SearchFrontendAsyncClient::vnx_set_config_object(const ::vnx::Object& config, const std::function<void()>& _callback, const std::function<void(const std::exception&)>& _error_callback) {
...
uint64_t SearchFrontendAsyncClient::vnx_set_config(const std::string& name, const ::vnx::Variant& value, const std::function<void()>& _callback, const std::function<void(const std::exception&)>& _error_callback) {
...
uint64_t SearchFrontendAsyncClient::vnx_get_type_code(const std::function<void(::vnx::TypeCode)>& _callback, const std::function<void(const std::exception&)>& _error_callback) {
...
uint64_t SearchFrontendAsyncClient::vnx_restart(const std::function<void()>& _callback, const std::function<void(const std::exception&)>& _error_callback) {
...
uint64_t SearchFrontendAsyncClient::vnx_close(const std::function<void()>& _callback, const std::function<void(const std::exception&)>& _error_callback) {
...
uint64_t SearchFrontendAsyncClient::http_request(const std::shared_ptr<const ::vnx::addons::HttpRequest>& request, const std::string& sub_path, const std::function<void(std::shared_ptr<const ::vnx::addons::HttpResponse>)>& _callback, const std::function<void(const std::exception&)>& _error_callback) {
...
std::vector<uint64_t> SearchFrontendAsyncClient::vnx_get_pending_ids() const {
	std::lock_guard<std::mutex> _lock(vnx_mutex);
...
void SearchFrontendAsyncClient::vnx_purge_request(uint64_t _request_id, const std::exception& _ex) {
...
void SearchFrontendAsyncClient::vnx_callback_switch(uint64_t _request_id, std::shared_ptr<const vnx::Value> _value) {
	std::unique_lock<std::mutex> _lock(vnx_mutex);
	...
	if(_type_hash == vnx::Hash64(0xa913f47dc68e4876ull)) {
		...
		if(!_result) {
			throw std::logic_error("SearchFrontendAsyncClient: !_result");
		}
		const auto _iter = vnx_queue_vnx_get_config_object.find(_request_id);
		if(_iter != vnx_queue_vnx_get_config_object.end()) {
			...
			throw std::runtime_error("SearchFrontendAsyncClient: received unknown return request_id");
		}
	}
		...
		throw std::runtime_error("SearchFrontendAsyncClient: received unknown return type");
	}
}
