...
const vnx::Hash64 CrawlProcessorBase::VNX_CODE_HASH(0x42c661da4dff26d7ull);
...
void CrawlProcessorBase::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[9], 9); vnx::accept(_visitor, sync_interval);
	_visitor.type_field(_type_code->fields[10], 10); vnx::accept(_visitor, max_per_minute);
	_visitor.type_field(_type_code->fields[11], 11); vnx::accept(_visitor, max_num_pending);
	_visitor.type_field(_type_code->fields[12], 12); vnx::accept(_visitor, max_queue_size);
	_visitor.type_field(_type_code->fields[13], 13); vnx::accept(_visitor, max_url_length);
	_visitor.type_field(_type_code->fields[14], 14); vnx::accept(_visitor, max_word_length);
	_visitor.type_field(_type_code->fields[15], 15); vnx::accept(_visitor, num_threads);
	_visitor.type_field(_type_code->fields[16], 16); vnx::accept(_visitor, check_interval_ms);
	_visitor.type_field(_type_code->fields[17], 17); vnx::accept(_visitor, robots_timeout);
	_visitor.type_field(_type_code->fields[18], 18); vnx::accept(_visitor, robots_reload_interval);
	_visitor.type_field(_type_code->fields[19], 19); vnx::accept(_visitor, commit_delay);
	_visitor.type_field(_type_code->fields[20], 20); vnx::accept(_visitor, lock_timeout);
	_visitor.type_field(_type_code->fields[21], 21); vnx::accept(_visitor, reload_power);
	_visitor.type_field(_type_code->fields[22], 22); vnx::accept(_visitor, index_version);
...
std::shared_ptr<vnx::TypeCode> CrawlProcessorBase::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x42c661da4dff26d7ull);
...
void write(TypeOutput& out, const ::vnx::search::CrawlProcessorBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 24, value.max_queue_size);
	vnx::write_value(_buf + 28, value.max_url_length);
	vnx::write_value(_buf + 32, value.max_word_length);
	vnx::write_value(_buf + 36, value.num_threads);
	vnx::write_value(_buf + 40, value.check_interval_ms);
	vnx::write_value(_buf + 44, value.robots_timeout);
	vnx::write_value(_buf + 48, value.robots_reload_interval);
	vnx::write_value(_buf + 52, value.commit_delay);
	vnx::write_value(_buf + 56, value.lock_timeout);
	vnx::write_value(_buf + 60, value.reload_power);
	vnx::write_value(_buf + 64, value.index_version);
	vnx::write_value(_buf + 68, value.inititial_sync);
