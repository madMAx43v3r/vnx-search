...
const vnx::Hash64 CrawlProcessorBase::VNX_CODE_HASH(0x6fb25b371ef5b57full);
...
void CrawlProcessorBase::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[3], 3); vnx::accept(_visitor, max_depth);
	_visitor.type_field(_type_code->fields[4], 4); vnx::accept(_visitor, reload_interval);
	_visitor.type_field(_type_code->fields[5], 5); vnx::accept(_visitor, sync_interval);
	...
	_visitor.type_field(_type_code->fields[8], 8); vnx::accept(_visitor, max_url_length);
	...
	_visitor.type_field(_type_code->fields[11], 11); vnx::accept(_visitor, root_urls);
	_visitor.type_field(_type_code->fields[12], 12); vnx::accept(_visitor, url_index_server);
	_visitor.type_field(_type_code->fields[13], 13); vnx::accept(_visitor, crawl_frontend_server);
...
std::shared_ptr<vnx::TypeCode> CrawlProcessorBase::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x6fb25b371ef5b57full);
...
void read(TypeInput& in, ::vnx::search::CrawlProcessorBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const vnx::TypeField* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 11: vnx::read(in, value.root_urls, type_code, _field->code.data()); break;
			case 12: vnx::read(in, value.url_index_server, type_code, _field->code.data()); break;
			case 13: vnx::read(in, value.crawl_frontend_server, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::vnx::search::CrawlProcessorBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write(out, value.root_urls, type_code, type_code->fields[11].code.data());
	vnx::write(out, value.url_index_server, type_code, type_code->fields[12].code.data());
	vnx::write(out, value.crawl_frontend_server, type_code, type_code->fields[13].code.data());
}
