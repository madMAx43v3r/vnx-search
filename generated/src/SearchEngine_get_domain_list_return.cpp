...
vnx::Variant SearchEngine_get_domain_list_return::get_field(const std::string& _name) const {
	if(_name == "_ret_0") {
...
void SearchEngine_get_domain_list_return::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "_ret_0") {
		_value.to(_ret_0);
	} else {
