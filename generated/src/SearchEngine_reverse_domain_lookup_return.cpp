...
vnx::Variant SearchEngine_reverse_domain_lookup_return::get_field(const std::string& _name) const {
	if(_name == "_ret_0") {
...
void SearchEngine_reverse_domain_lookup_return::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "_ret_0") {
		_value.to(_ret_0);
	} else {
