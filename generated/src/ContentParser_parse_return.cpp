...
vnx::Variant ContentParser_parse_return::get_field(const std::string& _name) const {
	if(_name == "_ret_0") {
...
void ContentParser_parse_return::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "_ret_0") {
		_value.to(_ret_0);
	} else {
...
std::shared_ptr<vnx::TypeCode> ContentParser_parse_return::static_create_type_code() {
	...
	type_code->native_size = sizeof(::vnx::search::ContentParser_parse_return);
