...
uint64_t SearchInterfaceAsyncClient::get_page_ranking(const int32_t& limit, const uint32_t& offset, const std::function<void(const std::vector<std::pair<std::string, vnx::float32_t>>&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t SearchInterfaceAsyncClient::get_word_context(const std::string& word, const int32_t& limit, const uint32_t& offset, const std::function<void(const std::vector<std::pair<std::string, vnx::float32_t>>&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t SearchInterfaceAsyncClient::reverse_lookup(const std::string& url_key, const int32_t& limit, const uint32_t& offset, const std::function<void(const std::vector<std::pair<std::string, vnx::float32_t>>&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t SearchInterfaceAsyncClient::reverse_domain_lookup(const std::string& url_key, const int32_t& limit, const uint32_t& offset, const std::function<void(const std::vector<std::pair<std::string, uint32_t>>&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t SearchInterfaceAsyncClient::suggest_words(const std::string& prefix, const int32_t& limit, const std::function<void(const std::vector<std::pair<std::string, uint32_t>>&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
