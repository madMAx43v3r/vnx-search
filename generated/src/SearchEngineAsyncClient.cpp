...
uint64_t SearchEngineAsyncClient::get_domain_info(const ::std::string& host, const ::int32_t& limit, const ::uint32_t& offset, const std::function<void(::std::shared_ptr<const ::vnx::search::DomainIndex>)>& _callback) {
...
uint64_t SearchEngineAsyncClient::get_domain_list(const ::int32_t& limit, const ::uint32_t& offset, const std::function<void(::std::vector<::vnx::search::DomainIndex>)>& _callback) {
	std::shared_ptr<vnx::Binary> _argument_data = vnx::Binary::create();
	vnx::BinaryOutputStream _stream_out(_argument_data.get());
	vnx::TypeOutput _out(&_stream_out);
