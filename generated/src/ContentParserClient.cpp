...
::vnx::Object ContentParserClient::vnx_get_config_object() {
	...
	if(auto _result = std::dynamic_pointer_cast<const ::vnx::ModuleInterface_vnx_get_config_object_return>(_return_value)) {
		...
		throw std::logic_error("ContentParserClient: invalid return value");
	}
}
...
std::shared_ptr<const ::vnx::ModuleInfo> ContentParserClient::vnx_get_module_info() {
...
void ContentParserClient::vnx_stop() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, false);
}

void ContentParserClient::vnx_stop_async() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, true);
}

vnx::bool_t ContentParserClient::vnx_self_test() {
...
std::shared_ptr<const ::vnx::search::TextResponse> ContentParserClient::parse(std::shared_ptr<const ::vnx::search::HttpResponse> response) {
	auto _method = ::vnx::search::ContentParser_parse::create();
	_method->response = response;
	auto _return_value = vnx_request(_method, false);
	if(auto _result = std::dynamic_pointer_cast<const ::vnx::search::ContentParser_parse_return>(_return_value)) {
		return _result->_ret_0;
	} else if(_return_value && !_return_value->is_void()) {
		return _return_value->get_field_by_index(0).to<std::shared_ptr<const ::vnx::search::TextResponse>>();
	} else {
		throw std::logic_error("ContentParserClient: invalid return value");
	}
}
