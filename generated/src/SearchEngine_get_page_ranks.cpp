...
const char* SearchEngine_get_page_ranks::get_type_name() const {
	return "vnx.search.SearchEngine.get_page_ranks";
}
const vnx::TypeCode* SearchEngine_get_page_ranks::get_type_code() const {
	return vnx::search::vnx_native_type_code_SearchEngine_get_page_ranks;
}

std::shared_ptr<SearchEngine_get_page_ranks> SearchEngine_get_page_ranks::create() {
	return std::make_shared<SearchEngine_get_page_ranks>();
}

std::shared_ptr<vnx::Value> SearchEngine_get_page_ranks::clone() const {
	return std::make_shared<SearchEngine_get_page_ranks>(*this);
}

void SearchEngine_get_page_ranks::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void SearchEngine_get_page_ranks::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
	vnx::write(_out, *this, _type_code, _code);
}

void SearchEngine_get_page_ranks::accept(vnx::Visitor& _visitor) const {
...
void SearchEngine_get_page_ranks::read(std::istream& _in) {
...
vnx::Object SearchEngine_get_page_ranks::to_object() const {
	vnx::Object _object;
...
vnx::Variant SearchEngine_get_page_ranks::get_field(const std::string& _name) const {
	if(_name == "url_keys") {
...
/// \private
std::ostream& operator<<(std::ostream& _out, const SearchEngine_get_page_ranks& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, SearchEngine_get_page_ranks& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* SearchEngine_get_page_ranks::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> SearchEngine_get_page_ranks::static_create_type_code() {
...
void write(TypeOutput& out, const ::vnx::search::SearchEngine_get_page_ranks& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::search::vnx_native_type_code_SearchEngine_get_page_ranks;
		out.write_type_code(type_code);
		vnx::write_class_header<::vnx::search::SearchEngine_get_page_ranks>(out);
	}
