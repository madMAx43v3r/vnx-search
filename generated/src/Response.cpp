...
const vnx::Hash64 Response::VNX_CODE_HASH(0xe307a296983caf72ull);
...
const vnx::TypeCode* Response::static_get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0xcf371c90803a778cull));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> Response::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0xe307a296983caf72ull);
