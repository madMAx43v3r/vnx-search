...
const vnx::Hash64 result_item_t::VNX_CODE_HASH(0xb1fbaf4772c121daull);

vnx::Hash64 result_item_t::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string result_item_t::get_type_name() const {
...
void result_item_t::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[4], 4); vnx::accept(_visitor, context);
...
std::shared_ptr<vnx::TypeCode> result_item_t::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0xb1fbaf4772c121daull);
	type_code->is_native = true;
	type_code->is_class = true;
	type_code->native_size = sizeof(::vnx::search::result_item_t);
...
void read(TypeInput& in, ::vnx::search::result_item_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 4: vnx::read(in, value.context, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::vnx::search::result_item_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write(out, value.context, type_code, type_code->fields[4].code.data());
}
