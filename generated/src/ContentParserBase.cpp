...
std::string ContentParserBase::get_type_name() const {
...
std::shared_ptr<vnx::TypeCode> ContentParserBase::static_create_type_code() {
	...
	type_code->native_size = sizeof(::vnx::search::ContentParserBase);
	...
	type_code->methods[9] = ::vnx::search::ContentParser_parse::static_get_type_code();
...
void ContentParserBase::vnx_handle_switch(std::shared_ptr<const vnx::Value> _value) {
...
std::shared_ptr<vnx::Value> ContentParserBase::vnx_call_switch(std::shared_ptr<const vnx::Value> _method, const vnx::request_id_t& _request_id) {
	switch(_method->get_type_hash()) {
		...
		case 0x3a3496c5361fbf35ull: {
			auto _args = std::static_pointer_cast<const ::vnx::search::ContentParser_parse>(_method);
