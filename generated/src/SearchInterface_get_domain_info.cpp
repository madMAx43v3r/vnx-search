...
const vnx::Hash64 SearchInterface_get_domain_info::VNX_CODE_HASH(0xbf79a402e92bd41full);
...
std::shared_ptr<vnx::TypeCode> SearchInterface_get_domain_info::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0xbf79a402e92bd41full);
	type_code->is_native = true;
	type_code->is_class = true;
	type_code->is_method = true;
	type_code->native_size = sizeof(::vnx::search::SearchInterface_get_domain_info);
