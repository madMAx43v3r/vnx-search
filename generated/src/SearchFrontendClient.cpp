...
::vnx::Object SearchFrontendClient::vnx_get_config_object() {
	...
	if(auto _result = std::dynamic_pointer_cast<const ::vnx::ModuleInterface_vnx_get_config_object_return>(_return_value)) {
		...
		throw std::logic_error("SearchFrontendClient: invalid return value");
	}
}
...
std::shared_ptr<const ::vnx::ModuleInfo> SearchFrontendClient::vnx_get_module_info() {
...
void SearchFrontendClient::vnx_stop() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, false);
}

void SearchFrontendClient::vnx_stop_async() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, true);
}

vnx::bool_t SearchFrontendClient::vnx_self_test() {
...
std::shared_ptr<const ::vnx::addons::HttpResponse> SearchFrontendClient::http_request(std::shared_ptr<const ::vnx::addons::HttpRequest> request, const std::string& sub_path) {
...
std::shared_ptr<const ::vnx::addons::HttpResponse> SearchFrontendClient::http_request_chunk(std::shared_ptr<const ::vnx::addons::HttpRequest> request, const std::string& sub_path, const int64_t& offset, const int64_t& max_bytes) {
